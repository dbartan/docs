...
<CardGroup cols={3}>
  <Card title="PDF" icon="file-pdf">
    Teknik dokümanlar, raporlar
    **Max: 10MB**
  </Card>

  <Card title="CAD Çizimleri" icon="compass-drafting">
    DWG, DXF, DWF
    **Max: 50MB**
  </Card>

  <Card title="Resimler" icon="image">
    JPG, PNG, WEBP
    **Max: 5MB**
  </Card>

  <Card title="Office Dokümanları" icon="file-word">
    DOCX, XLSX, PPTX
    **Max: 10MB**
  </Card>

  <Card title="Sıkıştırılmış" icon="file-zipper">
    ZIP, RAR (otomatik açılmaz)
    **Max: 100MB**
  </Card>
...
<img src="/images/qr-code-scan.png" alt="QR Code Scanning" />
...
<CardGroup cols={2}>
  <Card title="Kontrol Listeleri" icon="clipboard-check" href="/concepts/inspections">
    Kontrollerde doküman kullanımı
  </Card>

  <Card title="API Referansı" icon="code" href="/api-reference/endpoints/documents">
